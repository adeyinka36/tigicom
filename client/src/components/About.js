        ...
        <div className="about_container">
          <div className="about_top">
            <div className="about_text">
               <h1>WHO IS TIGI?</h1>
               <p> Tigi is a  20 year old, who specializes in natural lace wigs and has mastered making wigs on the sewing machine. She is known for her flawless customizing of the lace hairline and her signature curls.</p>
               <p> Tigi also has a passion for eyelashes .This led her  to become one of the most reliable and afordable merchants of eyelashes in london</p>
            </div>
